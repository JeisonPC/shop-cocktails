...
class CocktailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cocktail" do
    assert_difference("Cocktail.count") do
      post cocktails_url, params: { cocktail: { category: @cocktail.category, ingredients: @cocktail.ingredients, name: @cocktail.name, price: @cocktail.price, recipe: @cocktail.recipe } }
    end
  ...
  test "should update cocktail" do
    patch cocktail_url(@cocktail), params: { cocktail: { category: @cocktail.category, ingredients: @cocktail.ingredients, name: @cocktail.name, price: @cocktail.price, recipe: @cocktail.recipe } }
